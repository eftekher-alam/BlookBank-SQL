IF DB_ID('db1264783') IS NULL
	CREATE DATABASE db1264783
...
WITH ENCRYPTION
AS
SELECT H.hospitalName, P.patiantName, P.patiantAddress, D.donorName, D.donorAddress, CAST(PD.timeOfDonation AS DATE)
FROM patiants P
